...
public class RemoveStudent implements ActionListener {
	...
	public RemoveStudent(Connection conn) {
		// TODO Auto-generated constructor stub
		dbConn = conn;

	}

	public void deleteStudentInfo(String[] strInfoStudent){
		DBInfo dbInfo = new DBInfo();
		dbInfo.deleteStudentInfo(strInfoStudent, dbConn);
	...
	public void actionPerformed (ActionEvent e) {   
	    ...
	    bSubmit.addActionListener(new ActionListener() {
	    	public void actionPerformed(ActionEvent e) {
	    		...
	    		deleteStudentInfo(strStudentInfo);
